...
RESN_embed_dir = "../embeds/wv_3d_linear_filtered/align=0.5"
seeds = 4
...
syn_x_train = pickle.load(open("../datasets/wv_3d_linear/train_features.pkl","rb"))
syn_x_test = pickle.load(open("../datasets/wv_3d_linear/test_features.pkl","rb"))
...
align_dir = "../models/configs/wv_3d_linear/triplets/unfiltered"
