...
# dataset = torchvision.datasets.ImageFolder(data_dir, transform=utils.bm_transform_aug())
...
ckpt = "results/MTL_2/294058j9/checkpoints/best_model.ckpt" 

embed_path = "embeds/MTL_BCETN_bm_valid.pkl"

utils.get_embeds(model_path, args, ckpt, "valid", embed_path)